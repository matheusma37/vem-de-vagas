...
ActiveRecord::Schema.define(version: 2021_03_08_210702) do
  ...
  create_table "proposal_responses", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["job_application_id"], name: "index_proposal_responses_on_job_application_id"
  end
  ...
  add_foreign_key "proposal_responses", "job_applications"
